...
import "../assets/style/BasicStructure.scss";
    ...
    return (
      <Layout style={{ height: "100vh" }}>
        <Header className="header">
          <div className="logo">
            <img src="assets/images/typescripticon.svg" width="40" alt="typescript-icon" />
          </div>
        ...
        <Layout>
          ...
          >
            <Menu mode="inline" selectedKeys={[this.props.history.location.pathname]}>
              {AsideMenu}
            </Menu>
          </Sider>
          <Layout>
...
export default withRouter(CommonAside);
